export default function Title() {
  return (
    <div className="bg-white pt-12 pb-10 px-4 text-center">      
      ...
      <h1 className="text-5xl sm:text-6xl font-extrabold text-green-600 leading-tight mb-4">Амархан</h1>
      ...
      <div className="max-w-2xl mx-auto">
        <div className="flex items-center gap-0 bg-white border-2 border-gray-200 rounded-2xl shadow-lg overflow-hidden focus-within:border-green-400 focus-within:shadow-xl transition-all duration-200">
          ...
          <button className="m-2 px-7 py-2.5 bg-green-600 hover:bg-green-700 active:bg-green-800 text-white font-semibold text-sm rounded-xl transition-colors shrink-0">Хайх</button>
        </div>
      </div>
