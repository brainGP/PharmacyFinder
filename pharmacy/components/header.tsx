      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-14 gap-4">
          ...
          <div className="hidden md:block flex-1 max-w-md">
            <input placeholder="Эм, эмийн сан хайх..." className="w-full px-4 py-1.5 text-sm text-gray-700 bg-gray-100 rounded-full border-0 focus:outline-none focus:ring-2 focus:ring-blue-400"/>
          </div>
          <div className="flex items-center gap-2">
            <button className="hidden md:block bg-blue-600 text-white px-4 py-1.5 rounded-md text-sm">Нэвтрэх</button>
