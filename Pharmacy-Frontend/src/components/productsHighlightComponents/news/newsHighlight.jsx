...
function NewsHighlight(){
    return(
        <div class="rounded-[20px] flex flex-col gap-[14px]">
            <img class="max-h-[320px] rounded-t-[20px]"src="https://cdn.britannica.com/25/93825-050-D1300547/collection-newspapers.jpg"/>
